...
JSON_RESPONSE_FORMAT_VERSION = 2
...
DB_GPS_PLUGIN_METADATA_HEADERS = ['ss_gps_lat', 'ss_gps_lon', 'ss_location', 'ss_sog', 'ss_cog',
                                  'ss_distance_from_last_entry', 'ss_cumulative_distance']
DB_GPS_PLUGIN_SUMMARY_HEADERS = ['ss_start_location', 'ss_end_location', 'ss_start_gps_lat', 'ss_start_gps_lon',
                                 'ss_end_gps_lat', 'ss_end_gps_lon', 'ss_distance', 'ss_heading', 'ss_avg_sog']
DB_NMEA_PLUGIN_METADATA_HEADERS = ['nm_true_hdg', 'nm_tws', 'nm_twd', 'nm_aws', 'nm_awa', 'nm_gps_lat', 'nm_gps_lon',
                                   'nm_water_temperature', 'nm_depth', 'nm_sog', 'nm_sow',
                                   'nm_distance_from_last_entry', 'nm_cumulative_distance']
DB_NMEA_PLUGIN_SUMMARY_HEADERS = ['nm_start_location', 'nm_end_location', 'nm_start_gps_lat', 'nm_start_gps_lon',
                                  'nm_end_gps_lat', 'nm_end_gps_lon', 'nm_distance', 'nm_heading', 'nm_avg_wind_speed',
                                  'nm_avg_wind_direction', 'nm_avg_water_temperature', 'nm_avg_depth', 'nm_avg_sog',
                                  'nm_avg_sow']
DB_VICTRON_PLUGIN_METADATA_HEADERS = ['gx_active_input_source', 'gx_grid1_power', 'gx_generator1_power',
                                      ...
                                      'gx_start_batt_voltage', 'gx_tank1_level', 'gx_tank1_type', 'gx_tank2_level',
                                      'gx_tank2_type']
DB_VICTRON_PLUGINS_SUMMARY_HEADERS = ['gx_batt_max_voltage', 'gx_batt_min_voltage', 'gx_batt_avg_voltage',
                                      'gx_batt_max_current', 'gx_batt_avg_current', 'gx_batt_max_power',
                                      'gx_batt_avg_power', 'gx_pv_max_power', 'gx_pv_avg_power', 'gx_pv_max_current',
                                      'gx_pv_avg_current', 'gx_start_batt_max_voltage', 'gx_start_batt_min_voltage',
                                      'gx_start_batt_avg_voltage', 'gx_ac_consumption_max', 'gx_ac_consumption_avg',
                                      'gx_tank1_max_level', 'gx_tank1_min_level', 'gx_tank1_avg_level',
                                      'gx_tank2_max_level', 'gx_tank2_min_level', 'gx_tank2_avg_level']
